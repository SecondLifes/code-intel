...
| "Should we add reranking / change hybrid fusion?" | This repo already does hybrid dense+sparse with RRF fusion (`src/retrieval.py`) — treat this skill's guidance as tuning an existing setup, not choosing whether to adopt hybrid search. |
