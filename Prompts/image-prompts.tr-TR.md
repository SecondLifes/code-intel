...
- **Dört parça arketipi:** savrulan/toplanan kod parçaları asla jenerik
  yumrular değil — her biri, hiçbir zaman gerçek metinle değil yalnızca
  şekil ve dokuyla, farklı bir dili çağrıştıran dört ayrı silüet ailesi
  olarak okunuyor: bir **Delphi** parçası, uçlarında küçük parantez-çentiği
  olan, resmi çift-çizgili çerçeveli, mühürlü bir tomar gibi dikdörtgen
  tablet-parçası (bu, bekçinin kendi doğal şekli — en sık ve en büyük
  görünen o, çünkü Delphi CodeIntel'in en derin evi); bir **C++** parçası,
  kenarlarından fırlayan keskin işaretçi-benzeri dikenleri ve katmanlı
  şevron yüzeyleri olan açılı, çok yüzeyli bir parça — metalik ve
  sistem-seviyesinde soğuk parıltılı ama yine de bekçinin ışığıyla
  ısınmış; bir **Python** parçası, yumuşak inen basamaklarla kıvrılan,
  hiç sert kenarı olmayan, akıcı, yılankavi bir kurdele; bir **C#**
  parçası, hafif noktalı kafes dokulu, yüzeyinin hemen üzerinde
  süzülen iki-üç küçük yörüngesel flama-lekesi olan yuvarlak-köşeli bir
  parça. Dört ailenin de aynı boyut aralığı ve aynı pas-amber'den
  camgöbeğine dönüşüm yayı var — bunlar bir hiyerarşi değil, kardeşler.
